...
//let t1 = 0;
     ...
     var c = document.getElementById("canvas");
        ...
        function drawSpeedo(speed, gear, rpm, topSpeed) {
            ...
            ctx.beginPath();
            ctx.strokeStyle = "rgba(250, 102, 102,1)";
            ctx.lineWidth = 10;
            ...
            ctx.font = "20px Quantico-Bold";
            ctx.textAlign = "center";
            ctx.fillText("fefe", 200, 290);
            ...
            ctx.arc(250, 250, 220, .6 * Math.PI, calculateSpeedAngle(speed / topSpeed, 83.07888, 34.3775) * Math.PI);
            ctx.stroke();
            ctx.beginPath();
            ctx.lineWidth = 50;
